    ...
    <div className="min-h-screen bg-background">
      ...
      >
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link to="/register">
              <Button size="sm" className="water-gradient text-primary-foreground">Register Shop</Button>
            </Link>
          </div>
        </div>
      </motion.nav>
        ...
        <div className="absolute inset-0 overflow-hidden">
          {heroImages.map((src, index) => (
            <motion.img
              key={src}
              src={src}
              alt="Purifies vendor platform visual"
            ...
            <div className="text-center lg:text-left">
              ...
              >
                <span className="hero-heading-gradient">
                  Grow Your Water Business Online.
                </span>
              </motion.h1>
              <motion.p 
                initial={{ opacity: 0, y: 30 }}
              ...
              >
                Manage orders, subscriptions, inventory, and earnings — all from one powerful vendor dashboard.
              </motion.p>
              <motion.div 
                initial={{ opacity: 0, y: 30 }}
                animate={{ opacity: 1, y: 0 }}
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              What is <span className="water-gradient-text">Purifies Vendor</span>?
            </h2>
            <p className="text-lg text-muted-foreground">
              Purifies Vendor is your all-in-one shop management platform. List your water products, receive customer orders in real-time, manage subscriptions, and track your earnings — all digitally.
            </p>
          </motion.div>
          ...
          >
            {[
              { icon: ShoppingBag, label: "Receive Orders", desc: "Real-time customer orders" },
              { icon: RefreshCw, label: "Manage Subscriptions", desc: "Recurring delivery plans" },
              { icon: Package, label: "Inventory Control", desc: "Track stock levels" },
              { icon: BarChart3, label: "Earnings Analytics", desc: "Revenue insights" },
            ].map((item, index) => (
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Why <span className="water-gradient-text">Purifies Vendor</span>?
            </h2>
            <p className="text-lg text-muted-foreground">
              Say goodbye to manual order management
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            >
              <Card className="p-8 bg-destructive/5 border-destructive/20 h-full">
                ...
                <ul className="space-y-4">
                  {[
                    "Phone calls for every single order",
                    "Paper-based record keeping",
                    "No visibility into daily earnings",
            ...
            >
              <Card className="p-8 bg-secondary/5 border-secondary/20 h-full">
                ...
                <ul className="space-y-4">
                  {[
                    "Digital orders with instant notifications",
                    "Automated inventory & stock management",
                    "Real-time earnings & analytics dashboard",
                    "Subscription management built-in",
                    "Multi-language support for local vendors",
                  ].map((solution, index) => (
                    <motion.li 
                      key={index}
                      initial={{ opacity: 0, x: 20 }}
      ...
      <section id="how-it-works" className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground">
              Start selling water online in 4 simple steps
            </p>
          </motion.div>
          ...
          >
            {[
              { icon: Phone, step: "01", title: "Register", desc: "Sign up & set up your shop profile" },
              { icon: Package, step: "02", title: "List Products", desc: "Add water jars, prices & availability" },
              { icon: ClipboardList, step: "03", title: "Receive Orders", desc: "Get real-time orders from customers" },
              { icon: Truck, step: "04", title: "Deliver & Earn", desc: "Fulfill orders and track your revenue" },
            ].map((item, index) => (
              <motion.div 
                key={index} 
                variants={fadeInUp}
      ...
      <section id="features" className="py-20">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground">
              Everything you need to run your water business digitally
            </p>
          </motion.div>
          ...
          >
            {[
              { icon: ClipboardList, title: "Order Management", desc: "Accept, prepare, and track orders in real-time" },
              { icon: RefreshCw, title: "Subscription Handling", desc: "Manage recurring customer delivery plans effortlessly" },
              { icon: Package, title: "Inventory Control", desc: "Track stock levels and get low-stock alerts" },
              { icon: IndianRupee, title: "Earnings Dashboard", desc: "View daily, weekly, and monthly revenue analytics" },
              { icon: Settings, title: "Shop Settings", desc: "Update your shop profile, timings, and products" },
              { icon: Globe, title: "Multi-Language", desc: "Operate in English, Hindi, Marathi, or Kannada" },
            ].map((feature, index) => (
              <motion.div key={index} variants={scaleIn} transition={{ duration: 0.5 }}>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Who Can Use <span className="water-gradient-text">Purifies Vendor</span>?
            </h2>
            <p className="text-lg text-muted-foreground">
              Perfect for any water supply business
            </p>
          </motion.div>
          ...
          >
            {[
              { icon: Store, label: "Water Shops" },
              { icon: Building2, label: "RO Plant Owners" },
              { icon: Truck, label: "Delivery Suppliers" },
              { icon: Droplets, label: "Mineral Water Brands" },
              { icon: Users, label: "Local Distributors" },
            ].map((item, index) => (
              <motion.div key={index} variants={scaleIn} transition={{ duration: 0.5 }}>
      ...
      <section id="trust" className="py-20">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground">
              Built to empower your water business
            </p>
          </motion.div>
          ...
          >
            {[
              { icon: BadgeCheck, label: "Verified Platform", color: "bg-primary" },
              { icon: CreditCard, label: "Transparent Pricing", color: "bg-secondary" },
              { icon: Clock, label: "Real-time Orders", color: "bg-primary" },
              { icon: ShieldCheck, label: "Secure Dashboard", color: "bg-secondary" },
          ...
          >
            {["500+ Active Vendors", "10,000+ Orders Processed", "Real-time Analytics", "15+ Cities"].map((badge, index) => (
              <motion.div 
                key={index} 
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-primary-foreground mb-6">
            Start Selling Water the Smart Way
          </h2>
          <p className="text-lg text-primary-foreground/80 mb-8 max-w-2xl mx-auto">
            Join hundreds of vendors who trust Purifies to grow their water business
          </p>
          <motion.div 
            initial={{ opacity: 0, y: 20 }}
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div className="md:col-span-2">
              ...
              <p className="text-muted-foreground mt-4 max-w-md">
                Purifies Vendor — your digital partner for managing water supply orders, subscriptions, and revenue.
              </p>
            </div>
